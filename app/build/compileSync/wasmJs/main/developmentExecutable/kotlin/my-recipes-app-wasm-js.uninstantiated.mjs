...
export async function instantiate(imports={}, runInitializer=true) {
    ...
    const wasmFilePath = './my-recipes-app-wasm-js.wasm';
    const importObject = {
        js_code,
        intrinsics: {
    ...
    try {
      ...
      if (isBrowser) {
        wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./my-recipes-app-wasm-js.wasm',import.meta.url).href), importObject)).instance;
      }
    } catch (e) {
